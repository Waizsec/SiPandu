...
<body class="bg-[#FAFAFA]"> 
    ...
    <form action="/rating" method="post" class="w-full h-screen fixed flex items-center justify-center z-[20]">
        @csrf
        <div class="w-full fixed h-screen bg-black opacity-50"></div>
        <div class="w-[20vw] rounded-[0.3vw] py-[2vw] bg-white z-[100] flex items-center justify-center flex-col">
            <h1 class="text-[1vw]">Please Kindly, Give Us Rating</h1>
            <select name="rating" id="rating" class="text-[1vw] my-[2vw]">
            ...
            <button type="submit" class="text-[1vw] bg-blue-500 hover:bg-blue-700 text-white py-[0.3vw] px-[1vw] rounded">
                Submit Rating
            </button>    
        </div>
    </form>
    <form action="/rating" method="post" class="fixed z-[100]">
        @csrf
        <button type="submit" name="remove" value="true" class="text-[2vw] fixed top-[2vw] right-[4vw] text-white">x</button>
    </form>
    @endif
