...
<body>
    <div class="flex w-full h-[57vw] overflow-hidden">
        <form action="/register/auth" method="POST" class="w-[50vw] h-screen flex flex-col justify-center px-[15vw]">
            @csrf
            <h2 class="text-[1.8vw] font-semibold text-[#2B3674]">Sign Up</h2>
            ...
            <input type="text" name="name" class="w-full h-[3vw] border-[0.1vw] border-grey-500 placeholder:text-[0.9vw] pl-[1vw] mt-[1vw] mb-[1vw] rounded-[1vw] text-[0.9vw] outline-none" placeholder="Ex: mymail@mail.com" required>
            <label for="email" class="text-biru text-[0.9vw] font-semibold">
                Email*
            </label>
            ...
            <label for="phone" class="text-biru text-[0.9vw] font-semibold">
                Phone Number*
            </label>
            <input type="text" name="phone" class="w-full h-[3vw] border-[0.1vw] border-grey-500 placeholder:text-[0.9vw] pl-[1vw] mt-[1vw] rounded-[1vw] text-[0.9vw] outline-none" placeholder="******" required>
            <label for="password" class="text-biru text-[0.9vw] font-semibold">
                Password*
            </label>
