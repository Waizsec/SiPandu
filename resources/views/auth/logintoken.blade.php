...
<body>
    <div class="flex w-full h-[57vw] overflow-hidden">
        <form class="w-[50vw] h-screen flex flex-col justify-center px-[15vw]" action="/staff/login/auth" method="post">
            @csrf
            <select name="role" id="loginto" class="text-[1.8vw] ml-[-0.5vw] font-semibold text-[#2B3674]">
                <option value="cashier" class="text-[1vw]">Cashier</option>
                <option value="stock" class="text-[1vw]">Stock</option>
            </select>
            ...
            <input type="text" name="tokens" class="w-full h-[3vw] border-[0.1vw] border-grey-500 placeholder:text-[0.9vw] pl-[1vw] mt-[1vw] mb-[1vw] rounded-[1vw] text-[0.9vw] outline-none" placeholder="Ex: ABHGS312">
